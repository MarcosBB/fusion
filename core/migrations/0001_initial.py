# Generated by Django 3.2 on 2021-06-09 16:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagens'), ('lni-stats-up', 'Gráfico'), ('lni-user', 'Usuário'), ('lni-layers', 'Dsign'), ('lni-mobile', 'Mobile'), ('lni-ricket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
